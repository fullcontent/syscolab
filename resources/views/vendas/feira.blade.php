...
<form ng-submit="adicionarVendaFeiraTemp(codigo)" name="scanCode">


	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Vendas na Feira" style="height: 100px; font-size: 90px;" ng-model="codigo" autocomplete="off" required>
</form>
...
{!! Form::open(array('url' => 'admin/vendasFeira', 'class' => 'form-horizontal')) !!}
