...
<form ng-submit="saidaEstoqueTemp(codigo)" name="scanCode">
	

	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Saida de itens do estoque" style="height: 100px; font-size: 40px;" ng-model="codigo" autocomplete="off">
