...
<form ng-submit="adicionarEstoqueCasaTemp(codigo)" name="scanCode">
	

	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Entrada de itens na Casa" style="height: 100px; font-size: 40px;" ng-model="codigo" autocomplete="off">
...
{!! Form::open(array('url' => 'admin/estoqueCasa', 'class' => 'form-horizontal')) !!}
