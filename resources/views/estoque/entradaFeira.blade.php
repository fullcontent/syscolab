...
<form ng-submit="adicionarEstoqueFeiraTemp(codigo)" name="scanCode">
	

	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Entrada de itens para Feira" style="height: 100px; font-size: 40px;" ng-model="codigo" autocomplete="off">
...
{!! Form::open(array('url' => 'admin/estoqueFeira', 'class' => 'form-horizontal')) !!}
