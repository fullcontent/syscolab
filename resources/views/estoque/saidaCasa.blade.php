...
<div class="container-fluid" ng-app="syscolab" ng-controller="estoqueCtrl" ng-init="operacao='{{$operacao}}'">
...
<form ng-submit="saidaEstoqueCasaTemp(codigo)" name="scanCode">
	

	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Retirada de itens da Casa" style="height: 100px; font-size: 40px;" ng-model="codigo" autocomplete="off">
...
{!! Form::open(array('url' => 'admin/estoqueSaidaCasa', 'class' => 'form-horizontal')) !!}
<table class="table table-bordered">
                       	...
                       	<div class="form-group">
	                        ...
	                        <button type="submit" class="btn btn-success btn-block">Confirmar Saida do estoque</button>
	                        </div>
