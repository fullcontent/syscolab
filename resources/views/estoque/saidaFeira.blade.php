...
<form ng-submit="saidaEstoqueFeiraTemp(codigo)" name="scanCode">
	

	<input class="form-control" type="text" id="codigo" name="codigo" placeholder="Saida de itens da Feira" style="height: 100px; font-size: 40px;" ng-model="codigo" autocomplete="off">
...
{!! Form::open(array('url' => 'admin/estoqueSaidaFeira', 'class' => 'form-horizontal')) !!}
