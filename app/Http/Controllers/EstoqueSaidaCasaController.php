...
class EstoqueSaidaCasaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
       ...
       $estoqueItens = EstoqueTemp::where('operacao',5)->get();
       ...
       return redirect('admin/estoqueSaidaCasa')->with('message', 'Produtos inseridos no estoque');
