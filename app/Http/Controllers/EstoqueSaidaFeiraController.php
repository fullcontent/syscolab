...
class EstoqueSaidaFeiraController extends Controller
{
    /**
    ...
    public function index()
    {
         ...
         return view('estoque.saidaFeira')
         ->with(['operacao'=>2]);
    ...
    public function store(Request $request)
    {
       ...
       $estoqueItens = EstoqueTemp::where('operacao',2)->get();
       ...
       return redirect('admin/estoqueSaidaFeira')->with('message', 'Produtos inseridos no estoque');
