...
class EstoqueEntradaCasaController extends Controller
{
    /**
    ...
    public function index()
    {
         ...
         return view('estoque.entradaCasa')
         ->with(['operacao'=>4]);
    ...
    public function store(Request $request)
    {
       ...
       $estoqueItens = EstoqueTemp::where('operacao',4)->get();
       ...
       return redirect('admin/estoqueCasa')->with('message', 'Casa Alimentada');
