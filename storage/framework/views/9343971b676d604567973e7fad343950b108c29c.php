    ...
    <div  style="width:750px;margin:0 auto ">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
					...
					<div class='form-group'>
						<label><?php echo e(trans('crudbooster.set_as_superadmin')); ?></label><br/>
						<div id='set_as_superadmin' class='radio inline'>
							<label><input required <?php echo e((@$row->is_superadmin==1)?'checked':''); ?> type='radio' name='is_superadmin' value='1'/> <?php echo e(trans('crudbooster.confirmation_yes')); ?></label> &nbsp;&nbsp;
							<label><input <?php echo e((@$row->is_superadmin==0)?'checked':''); ?> type='radio' name='is_superadmin' value='0'/> <?php echo e(trans('crudbooster.confirmation_no')); ?></label>
						</div>
					...
					<div id='privileges_configuration' class='form-group'>
						...
						<table class='table table-striped table-hover table-bordered'>
							<thead>
								<tr class='active'>
									<th width='3%'><?php echo e(trans('crudbooster.privileges_module_list_no')); ?></th><th width='60%'><?php echo e(trans('crudbooster.privileges_module_list_mod_names')); ?></th><th>&nbsp;</th><th><?php echo e(trans('crudbooster.privileges_module_list_view')); ?></th><th><?php echo e(trans('crudbooster.privileges_module_list_create')); ?></th><th><?php echo e(trans('crudbooster.privileges_module_list_read')); ?></th><th><?php echo e(trans('crudbooster.privileges_module_list_update')); ?></th><th><?php echo e(trans('crudbooster.privileges_module_list_delete')); ?></th>
								</tr>
								<tr class='info'>
									<th>&nbsp;</th>
									<th>&nbsp;</th>
