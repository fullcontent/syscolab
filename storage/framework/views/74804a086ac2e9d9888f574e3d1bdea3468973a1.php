...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(($page_title)?Session::get('appname').': '.strip_tags($page_title):"Admin Area"); ?></title>
...
<body class="<?php  echo (Session::get('theme_color'))?:'skin-blue'; echo ' '; echo config('crudbooster.ADMIN_LAYOUT');  ?>">
